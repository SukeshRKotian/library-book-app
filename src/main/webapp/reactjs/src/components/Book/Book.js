...
class Book extends Component {
    ...
    componentDidMount() {
        ...
        if(bookId) {
            this.findBookById(bookId, libraryId);
        }
    ...
    findAllLanguages = () => {
        axios.get("http://localhost:8081/rest/v0/libraries/"+this.props.libraryId+"/books/languages")
    ...
    findAllGenres = () => {
        axios.get("http://localhost:8081/rest/v0/libraries/"+this.props.libraryId+"/books/genres")
            .then(response => response.data)
            .then((data) => {
                this.setState({
    ...
    findBookById = (bookId) => {
        this.props.fetchBook(bookId, this.props.libraryId);
        setTimeout(() => {
    ...
    submitBook = event => {
        ...
        this.props.saveBook(book, this.props.libraryId);
        setTimeout(() => {
    ...
    updateBook = event => {
        ...
        this.props.updateBook(book, this.props.libraryId);
        setTimeout(() => {
    ...
    libraryList = () => {
        return this.props.history.push("/libraries");
    };
                            ...
                            <Form.Row>
                                <Form.Group as={Col} controlId="formGridCoverPhotoURL">
                                    ...
                                    <InputGroup>
                                        ...
                                        <InputGroup.Append>
                                            {this.state.coverPhotoURL !== '' && <Image src={this.state.coverPhotoURL} width="40" height="38"/>}
                                        </InputGroup.Append>
                                    </InputGroup>
                                </Form.Group>
...
const mapDispatchToProps = dispatch => {
    return {
        saveBook: (book, libraryId) => dispatch(saveBook(book, libraryId)),
        fetchBook: (bookId, libraryId) => dispatch(fetchBook(bookId, libraryId)),
        updateBook: (book, libraryId) => dispatch(updateBook(book, libraryId))
    };
};
